...
@section('style')
    ...
    <link href="{{asset('template/vendors/fullcalendar/css/fullcalendar.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('template/css/pages/calendar_custom.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" media="all" href="{{asset('template/vendors/jvectormap/jquery-jvectormap.css')}}" />
    <link rel="stylesheet" href="{{asset('template/vendors/animate/animate.min.css')}}">
    <link rel="stylesheet" href="{{asset('template/css/only_dashboard.css')}}" />
    @endsection
@section('content')
...
@section('script')
    ...
    <!-- EASY PIE CHART JS -->
    <script src="{{asset('template/vendors/charts/easypiechart.min.js')}}"></script>
    <script src="{{asset('template/vendors/charts/jquery.easypiechart.min.js')}}"></script>
    <!--for calendar-->
    <script src="{{asset('template/vendors/fullcalendar/fullcalendar.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('template/vendors/fullcalendar/calendarcustom.min.js')}}" type="text/javascript"></script>
    <!--   Realtime Server Load  -->
    <script src="{{asset('template/vendors/charts/jquery.flot.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('template/vendors/charts/jquery.flot.resize.min.js')}}" type="text/javascript"></script>
    <!--Sparkline Chart-->
    <script src="{{asset('template/vendors/charts/jquery.sparkline.js')}}"></script>
    <!-- Back to Top-->
    <script type="text/javascript" src="{{asset('template/vendors/countUp/countUp.js')}}"></script>
    <!--   maps -->
    <script src="{{asset('template/vendors/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
    ...
    <script src="{{asset('template/js/dashboard.js')}}" type="text/javascript"></script>
