            ...
            <ul id="menu" class="page-sidebar-menu">
                ...
                <li>
                    <a href="{{url('lenders')}}">
                        ...
                        <span class="badge badge-danger">{{count(\App\Models\Lender::all())}}</span>
{{--                        <span class="badge badge-danger">{{count(\App\Facades\Lender::lender()->all())}}</span>--}}
                        Lenders
                    </a>
                </li>
                ...
                <li>
                    <a href="{{url('debtors')}}">
                        ...
                        <span class="badge badge-danger">{{count(\App\Facades\Debtor::Debtor()->all())}}</span>
                        Debtors
                    </a>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="{{url('processingTransactions')}}">
                                <i class="fa fa-angle-double-right"></i>
                                Processing Transactions
                            </a>
                        </li>
                        <li>
                            <a href="{{url('completed_transactions')}}">
                                <i class="fa fa-angle-double-right"></i>
