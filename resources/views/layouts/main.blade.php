        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        {{--<img src="{{asset('uploads/user_pictures/'. Auth::User()->user_pic)}}" width="25" class="img-circle img-responsive pull-left" height="25" alt="riot">--}}
                        <div class="riot">
                            <div>
                                {{Auth::User()->user_name}}
                                <span>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header bg-light-blue">
                            <img src="{{asset('uploads/user_pictures/'. Auth::User()->user_pic)}}" class="img-responsive img-circle" alt="User Image">
                            <p class="topprofiletext">{{Auth::User()->user_name}}</p>
                        </li>
                        <!-- Menu Body -->
                        <li>
                            <a href="#">
                        ...
                        <li class="user-footer">
                            ...
                            <a href="{{ route('logout') }}"
                               onclick="event.preventDefault();
                                ...
                                <i class="livicon" data-name="logout" data-s="18"></i>
